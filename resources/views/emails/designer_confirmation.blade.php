...
<div class="wrapper" style="min-width: 320px;background-color: #fbfbfb;" lang="x-wrapper">
    ...
    <div class="header" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 179160px);" id="emb-email-header-container">
        <!--[if (mso)|(IE)]><table align="center" class="header" cellpadding="0" cellspacing="0"><tr><td style="width: 600px"><![endif]-->
        <div class="logo emb-logo-margin-box" style="font-size: 26px;line-height: 32px;Margin-top: 9px;Margin-bottom: 25px;color: #41637e;font-family: Avenir,sans-serif;Margin-left: 20px;Margin-right: 20px;" align="center">
            <div class="logo-center" style="font-size:0px !important;line-height:0 !important;" align="center" id="emb-email-header"><img style="height: auto;width: 100%;border: 0;max-width: 198px;" src="{{ asset('images/logo.jpg') }}" alt="Nattiv" width="198" /></div>
        </div>
        <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
    </div>
        ...
        <div class="layout__inner" style="border-collapse: collapse;display: table;background-color: #ffffff;" emb-background-style>
            ...
            <div class="column" style="text-align: left;color: #565656;font-size: 14px;line-height: 21px;font-family: Georgia,serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 179160px);">
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 24px;">
                    <h1 class="size-34" style="Margin-top: 0;Margin-bottom: 20px;font-style: normal;font-weight: normal;color: #565656;font-size: 30px;line-height: 38px;font-family: lato,tahoma,sans-serif;text-align: center;" lang="x-size-34"><span class="font-lato"><strong>WELCOME</strong></span></h1>
                </div>
                ...
                <div style="Margin-left: 20px;Margin-right: 20px;">
                    <p class="size-28" style="Margin-top: 0;Margin-bottom: 0;font-family: lato,tahoma,sans-serif;font-size: 24px;line-height: 32px;text-align: center;" lang="x-size-28"><span class="font-lato"><strong>Thank you for signing up at Nattiv.</strong></span></p><p class="size-28" style="Margin-top: 20px;Margin-bottom: 20px;font-family: lato,tahoma,sans-serif;font-size: 24px;line-height: 32px;text-align: center;" lang="x-size-28"><span class="font-lato"><strong>Please verify your account by clicking the button below</strong></span></p>
                </div>
    ...
    <div class="layout email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 179160px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;">
            ...
            <div class="column wide" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;Float: left;max-width: 400px;min-width: 320px; width: 320px;width: calc(8000vw - 50960px);">
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    <table class="email-footer__links emb-web-links" style="border-collapse: collapse;table-layout: fixed;"><tbody><tr>

                            <td class="emb-web-links" style="padding: 0;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="facebook.com"><img style="border: 0;" src="https://i1.createsend1.com/static/eb/beta/13-the-blueprint-3/images/facebook.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="twitter.com"><img style="border: 0;" src="https://i8.createsend1.com/static/eb/beta/13-the-blueprint-3/images/twitter.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="youtube.com"><img style="border: 0;" src="https://i10.createsend1.com/static/eb/beta/13-the-blueprint-3/images/youtube.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="instagram.com"><img style="border: 0;" src="https://i4.createsend1.com/static/eb/beta/13-the-blueprint-3/images/instagram.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="linkedin.com"><img style="border: 0;" src="https://i9.createsend1.com/static/eb/beta/13-the-blueprint-3/images/linkedin.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration:
underline;transition: opacity 0.1s ease-in;color: #999;" href="http://localhost:8181"><img style="border: 0;" src="https://i3.createsend1.com/static/eb/beta/13-the-blueprint-3/images/website.png" width="26" height="26" /></a></td><td class="emb-web-links" style="padding: 0 0 0 3px;width: 26px;"><a style="text-decoration: underline;transition: opacity 0.1s ease-in;color: #999;" href="pintrest.com"><img style="border: 0;" src="https://i2.createsend1.com/static/eb/beta/13-the-blueprint-3/images/pinterest.png" width="26" height="26" /></a></td>
                        </tr></tbody></table>
                    ...
                    <div style="Margin-top: 18px;">
                        <div>You are receiving this email because you have recently created an account with us at <a href="http://nattivv.com/designer">www.nattiv.com</a>, if this wan't you, feel free to unsubscribe.</div>
                    </div>
                </div>
            </div>
            <!--[if (mso)|(IE)]></td><td style="width: 200px;" valign="top" class="w160"><![endif]-->
            <div class="column narrow" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;Float: left;max-width: 320px;min-width: 200px; width: 320px;width: calc(77240px - 12000vw);">
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    <div class="footer__share-button">
                        <!--[if mso]><p style="line-height:0;">&nbsp;</p><![endif]-->
                        <p style="Margin-top: 0;Margin-bottom: 5px;line-height: 26px;mso-line-height-rule: exactly;"><fblike class="fblike" style="background-image: url(https://i5.createsend1.com/static/eb/beta/13-the-blueprint-3/images/fblike.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7e7e7e;" cs-button data-vml-width="64" left-align-text="true">Like</fblike></p>
                        <p style="Margin-top: 0;Margin-bottom: 5px;line-height: 26px;mso-line-height-rule: exactly;"><tweet class="tweet" style="background-image: url(https://i9.createsend1.com/static/eb/beta/13-the-blueprint-3/images/tweet.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7e7e7e;" cs-button data-vml-width="73" left-align-text="true">Tweet</tweet></p>
                        <p style="Margin-top: 0;Margin-bottom: 5px;line-height: 26px;mso-line-height-rule: exactly;"><linkedinshare class="linkedinshare" style="background-image: url(https://i8.createsend1.com/static/eb/beta/13-the-blueprint-3/images/lishare.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7e7e7e;" cs-button data-vml-width="72" left-align-text="true">Share</linkedinshare></p>
                        <p style="Margin-top: 0;Margin-bottom: 5px;line-height: 26px;mso-line-height-rule: exactly;"><forwardtoafriend class="forwardtoafriend" style="background-image: url(https://i10.createsend1.com/static/eb/beta/13-the-blueprint-3/images/forward.png);background-repeat: no-repeat;background-size: 200px 56px;border-radius: 2px;color: #ffffff;display: inline-block;font-size: 11px;font-weight: bold;line-height: 11px;padding: 8px 11px 7px 28px;text-align: left;text-decoration: none;background-color: #7e7e7e;" cs-button data-vml-width="88" left-align-text="true">Forward</forwardtoafriend></p>
                    </div>
                </div>
            </div>
            <!--[if (mso)|(IE)]></td></tr></table><![endif]-->
    ...
    <div class="layout one-col email-footer" style="Margin: 0 auto;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 179160px);overflow-wrap: break-word;word-wrap: break-word;word-break: break-word;">
        <div class="layout__inner" style="border-collapse: collapse;display: table;">
            ...
            <div class="column" style="text-align: left;font-size: 12px;line-height: 19px;color: #999;font-family: Georgia,serif;max-width: 600px;min-width: 320px; width: 320px;width: calc(28000vw - 179160px);">
                <div style="Margin-left: 20px;Margin-right: 20px;Margin-top: 10px;Margin-bottom: 10px;">
                    <div>
